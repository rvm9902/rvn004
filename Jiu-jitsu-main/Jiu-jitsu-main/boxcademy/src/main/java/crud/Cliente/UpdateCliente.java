...
public class UpdateCliente {
    ...
    public static void executar(Scanner scanner) {
        ...
        do {
            ...
            System.out.println("0 - Voltar ao menu alunos");
    ...
    private static void atualizarCliente(Scanner scanner) {
        ...
        while (cliente == null) {
            System.out.print("Digite o ID do aluno que deseja atualizar (ou 0 para voltar): ");
            try {
        ...
        System.out.println("Novo estado do aluno:");
        System.out.println(cliente);
